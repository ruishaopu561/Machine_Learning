...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i, shape2 in enumerate(hidden_dims):
            ...
            if self.normalization:
                ...
                self.params['theta' + str(i + 1)] = np.ones(shape2)
    ...
    def loss(self, X, y=None):
        ...
        #    out, layer1_cache = affine_relu_forward(out, self.params['W' + str(i)], self.params['b' + str(i)])
        #    if self.use_dropout:
        #          self.bn_params[i-1] = 
        #scores, layer2_cache = affine_forward(out, self.params['W'+str(num_layers)], self.params['b'+str(num_layers)])
